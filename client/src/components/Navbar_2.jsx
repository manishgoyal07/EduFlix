        ...
        <div>
            <div className="navbar bg-base-100">
                ...
                <div className="flex-1 ml-16">
                    <Link to='/user/home'><a className="btn btn-ghost text-xl">EduFlix</a></Link>
                </div>
                <div className="flex-none gap-2">
                    ...
                    <button className='btn btn-success mr-40' onClick={handleSearch}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                    </svg>
                    </button>
                    <label className="cursor-pointer grid place-items-center mx-8">
                    ...
                    <div className="dropdown">
                        <div tabIndex={0} role="button" className="btn btn-info text-2xl font-bold"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
