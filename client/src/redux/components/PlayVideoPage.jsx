                ...
                <div className="artboard artboard-horizontal phone-5">
                    ...
                    <div className=" border flex flex-row justify-center bg-base-300 my-4">
                        ...
                        <div className='mx-20'>
                            ...
                            <div className="badge badge-warning badge-outline mx-2 mb-4">{myVideo?.views} views</div>
                            <div className="badge badge-info badge-outline mx-2 mb-4">{myVideo?.likesCount} likes</div>
                        </div>
